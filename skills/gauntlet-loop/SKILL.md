...
Vendored verbatim from [robonuggets/gauntlet-loop](https://github.com/robonuggets/gauntlet-loop)
(`.claude/skills/gauntlet-loop/SKILL.md`), retrieved 2026-08-09.
Licensed CC-BY-4.0 — https://creativecommons.org/licenses/by/4.0/
No changes to the skill body; this attribution section is the only addition.
