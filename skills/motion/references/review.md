...
> Vendored from github.com/emilkowalski/skills (review-animations + STANDARDS.md), pinned 2026-07-24. This is the merged motion-review skill: emilkowalski's `improve-animations` and `find-animation-opportunities` share this same STANDARDS.md catalog, so they were folded in rather than vendored separately. Manual-invoke only (`disable-model-invocation: true`).
