...
> Vendored from github.com/emilkowalski/skills (apple-design), pinned 2026-07-24. Single-author taste (Emil Kowalski / animations.dev) — treat the numeric values as strong defaults, not gospel.
