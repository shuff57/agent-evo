...
description: debugger equivalent running on Ollama (glm-5.2:cloud). Systematic root-cause diagnosis via reproduce/hypothesize/test/verify. Examples — "have ollama-debugger trace this error", "use ollama-debugger to find why X intermittently fails".
model: haiku
---
...
3. Run via Bash heredoc:
   ...
   ```
   Timeout: 600000ms.
4. Return stdout verbatim, prefixed: `--- ollama-debugger:glm-5.2:cloud ---`
